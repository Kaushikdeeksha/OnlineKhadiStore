            ...
            <div class="modal-content modal-info">
                ...
                <div class="modal-body modal-spa">
                        ...
                        <div class="login">
                            <div class="login-bottom">
                                ...
                                <form action="AddCustomer" method="post">
                                    <div class="sign-up">
                                        <h4>Your Name :</h4>
                                        <input type="text" placeholder="Your Name" required="" style="color: black ;width: 680px;" name="name">
                                    </div>
                                    <div class="sign-up">
                                        <h4>Email :</h4>
                                        <input type="email" id="email" name="email" style="width: 680px;" required>
                                <!--   <div class="icons">
                  ...
                  <span class="icon2 fas fa-check"></span>
                                    ...
                                    <div class="sign-up">
                                        <h4>Password :</h4>
                                        <input type="password"  pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}" style="width: 680px;" name="password">
                                    </div>
                                    <div class="sign-up">
                                        <h4>Phone :</h4>
                                        <input type="tel" placeholder="Type here" required="" pattern="[0-9]{10}"  style="width: 680px;" name="mobile">
                                    </div>
                                    <div class="sign-up">
                                        <h4>Gender :</h4>
                                        <br> <select class="form-control" required="" style="width: 680px;" name="gender">
                                            <option>Male</option>
                                    ...
                                    <br>
                                    <div class="sign-up">
                                        <h4>House No. and Address :</h4>
                                        <input type="text" placeholder="Type here" required="" style="color:black;min-height: 100px; width: 680px;" name="address">
                                    </div>
                                    <div class="sign-up">
                                        <h4>State :</h4>
                                        <input type="text" placeholder="State" required="" style="color:black;width: 680px;" name="state">
                                    </div>
                                     <div class="sign-up">
                                        <h4>City :</h4>
                                        <input type="text" placeholder="City" required="" style="color:black;width: 680px;" name="city">
                                    </div>
                                    <div class="sign-up">
                                        <h4>Pin Code :</h4>
                                        <input type="text" placeholder="Pincode" required="" style="color:black;width: 680px;" name="pincode">
                                    </div>
                                    <div class="sign-up">
