...
<%! String email,npwd,cpwd,query,query1;int x;%>
<!Doctype html>
<html lang="en">
...
<body>
	...
	<div class="left">
		...
		<div class="input">
			...
			<input type="text" placeholder="Enter Email ID to Get Password" name="email">
			
		</div>
                                        
                 
                    <input type="submit" value="Submit" name="login" /></div>
	</div>	
...
<%
      ...
      if(npwd.equals(cpwd)){
            query1="update tblcustomer set password='"+ npwd +"' where email = '"+email+"'";
      }
      
       x=DatabaseConnection.insertUpdateFromSqlQuery(query1);
