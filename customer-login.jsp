            ...
            <div class="modal-content modal-info">
                ...
                <div class="modal-body modal-spa">
                    <div class="login-grids">
                        <div class="login">
                            <div class="login-right">
                                ...
                                <form action="CustomerLogin" method="post">
                                    <div class="sign-in">
                                        <h4>Email :</h4>
                                        <input type="text"  pattern="[^ @]*@[^_@]*" value="" style="width: 680px;" required=""
                                               name="email">
                                        
                                    </div>
                                    <div class="sign-in">
                                        <h4>Password :</h4>
                                        <input type="password" minlength="8" value="" style="width: 680px;"
                        ...
                        <p>
                            <a href="customer-register.jsp">New to MyKhadi Shop? Create an account</a><br>
                            <span style="color: blue"><a href="forgotPassword.jsp">Forget Password?</span>
                        </p>
                    </div>
                </div>
            </div>
