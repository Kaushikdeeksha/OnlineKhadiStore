                            ...
                            <div class="panel-body">
                                ...
                                <form action="AdminLogin" method="post">
                                    <div class="form-group">
                                        <label>Email Id.:</label> <input type="text" pattern="[^ @]*@[^_@]*" name="email" class="form-control">
                                    </div>
                                    <div class="form-group">
                                        <label>Password.:</label> <input type="password" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}" name="upass" class="form-control">
                                    </div>
